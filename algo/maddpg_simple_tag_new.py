...
env = AsyncPettingZooVecEnv(
    [
        lambda: simple_tag_v3.parallel_env(num_adversaries=1, num_obstacles=1, continuous_actions=False)
...
agent = MADDPG(
    ...
    batch_size=16,         # 每次学习时采样的经验数量
    vect_noise_dim=num_envs,
    learn_step=100,           # 学习间隔，分类讨论大于环境数和小于环境数的情况，最好是环境数的整数倍或者反之
    device=device,
)
...
elite_agent_filename = f"elite_agent_simple_tag_v3_agilerl_MADDPG_{current_time}.pt"
