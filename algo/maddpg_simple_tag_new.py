...
def parse_args():
    ...
    parser.add_argument('--learn_intv', type=int, default=32, help='Learning intervals')
    parser.add_argument('--max_steps', type=int, default=100000, help='Training max steps')
    parser.add_argument('--warmup_stp', type=int, default=5000, help='Warming up steps')
...
if __name__ == "__main__":
    ...
    print(f"use command:\npython tests/test_maddpg_new.py --path {elite_agent_path} --num_good {num_good} --num_advs {num_adversaries} --num_obs {num_obstacles}\nto test")
